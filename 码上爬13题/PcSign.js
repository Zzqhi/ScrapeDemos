function createProxy(name, target = {}) {
    return new Proxy(target, {
        get(obj, prop) {
            var value = obj[prop];
            console.log(`[Proxy ${name}] get -> ${String(prop)} =`, value);
            if (typeof value === 'function') {
                return function (...args) {
                    var result = value.apply(obj, args);
                    console.log(`[Proxy ${name}] call -> ${String(prop)}(`, ...args, `) => `, result);
                    return result;
                };
            }
            return value;
        ...
        set(obj, prop, value) {
            console.log(`[Proxy ${name}] set -> ${String(prop)} =`, value);
            obj[prop] = value;
            return true;
        },
        getOwnPropertyDescriptor(obj, prop) {
            console.log(`[Proxy ${name}] getOwnPropertyDescriptor -> ${String(prop)}`);
...
var window = global;
var document = createProxy('document', {
    createElement: function (tag) {
        ...
        var props = {
            ...
            addEventListener(type, fn) { console.log(`[<${tag}>] addEventListener -> ${type}`); },
            removeEventListener() {},
        ...
        if (tag === 'canvas') {
            props.width = 300;
            props.height = 150;
            props.toDataURL = function () { return 'data:image/png;base64,';};
            props.getContext = function (type) {
                console.log(`[<canvas>] getContext ===> ${type}`);
                return createProxy('CanvasContext', {
                    ...
                    scale() {}, drawImage() {}, createLinearGradient() { return { addColorStop() {} }; },
                    getImageData() { return { data: new Uint8ClampedArray(0) }; },
                });
            };
        }
        var el = createProxy(`<${tag}>`, props);
        return el;
    },
    ...
    body: createProxy('<body>', {
        innerHTML: '<div class="main-content"></div>',
        childElementCount: 0,
        appendChild(child) {
            child.parentNode = this;
            this.childElementCount++;
    ...
    documentElement: createProxy('documentElement'),
    createEvent: function (val) {
        console.log("document.createEvent ===> " + val)
    },
    cookie: 'Hm_lvt_0d2227abf9548feda3b9cb6fddee26c0=1773810151,1773810402; HMACCOUNT=19F6CDE53094F092; Hm_lpvt_0d2227abf9548feda3b9cb6fddee26c0=1773817317',
...
function createPlugin(name, description, filename, mimeTypes) {
    var plugin = { name, description, filename, length: mimeTypes.length };
    mimeTypes.forEach((mt, i) => {
        var mime = createMimeType(mt.type, mt.suffixes, mt.description, plugin);
        plugin[i] = mime;
        plugin[mt.type] = mime;
    });
    return plugin;
...
// 模拟 PluginArray 的 item/namedItem/refresh
pluginList.item = function (index) { return pluginList[index] || null; };
pluginList.namedItem = function (name) { return pluginList.find(p => p.name === name) || null; };
pluginList.refresh = function () { };

var navigator = createProxy('navigator', {
    ...
    mimeTypes: {
        length: 2,
        0: createMimeType('application/pdf', 'pdf', 'Portable Document Format', pluginList[0]),
        1: createMimeType('text/pdf', 'pdf', 'Portable Document Format', pluginList[0]),
        'application/pdf': createMimeType('application/pdf', 'pdf', 'Portable Document Format', pluginList[0]),
        'text/pdf': createMimeType('text/pdf', 'pdf', 'Portable Document Format', pluginList[0]),
        item(i) { return this[i] || null; },
        namedItem(name) { return this[name] || null; },
    },
});
// 覆盖 Node.js 自带的 globalThis.navigator
...
// sessionStorage
var sessionStorage = createProxy('sessionStorage', {
    _data: {},
    getItem(key) { return this._data[key] || null; },
    setItem(key, value) { this._data[key] = String(value); },
    removeItem(key) { delete this._data[key]; },
...
window.PcSign = new window.Sign({
    ...
    "onSign": function onSign(e) {
        if (0 != e.code) {
            a.colorApi.postDraData(704, "Sign签名不可用", "Sign", "code != 0", "", "");
        }
    },
    "onRequestTokenRemotely": function onRequestTokenRemotely(e) {
        e.code;
